...
const NAVIGATION_MENU_ITEMS: NavigationMenuItem[] = [
  {
    id: "changes",
    label: "Admin: Änderungen",
    keywords: ["änderungen", "aenderungen", "freigaben", "approval", "antraege", "anträge", "queue", "review", "pruefung", "prüfung"],
    icon: "📝",
  ...
  },
  {
    id: "admin-news",
    label: "Admin: News",
    keywords: ["news", "neuigkeiten", "aktuelles", "home news", "ankündigung", "ankuendigung"],
    icon: "🗞️",
    permission: "config.edit",
    requiresAuth: true,
  },
  {
    id: "timekeeping",
    label: "Zeiterfassung",
    keywords: ["zeitnahme", "zeiterfassung", "stoppuhr", "zeiten", "raw", "sync"],
    icon: "✏️",
    permission: "timekeeping.use",
    requiresAuth: true,
  },
  {
    id: "admin-audits",
  ...
  },
  {
    id: "orga-links",
    label: "Orga Links",
    keywords: ["orga links", "orga-links", "links", "sammlung", "referenz", "architektur", "infrastruktur", "toolbox"],
    icon: "🗂️",
    requiresAuth: true,
  },
  {
