...
export const TeamRegistrationSchema = z.object({
  ...
  contactPhone: z.string({ error: "Telefonnummer ist fuer Mannschaftsanmeldungen erforderlich." }).trim().min(1, "Telefonnummer ist fuer Mannschaftsanmeldungen erforderlich.").max(64, "Telefonnummer zu lang"),
