...
- Verification before deploy:
  ...
  - `git diff --check` -> pass
- Deployment:
  - Commit: `885e062 Use raster MapTiler style for event map`
  - Pushed to `origin/main`: `ffeeab7..885e062`
...
- Verification before deploy:
  ...
  - `git diff --check` -> pass
- Deployment:
  - Commit: `139af0c Move sponsor details into map popups`
  - Pushed to `origin/main`: `c7484d5..139af0c`
