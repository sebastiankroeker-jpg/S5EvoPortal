    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-5xl mx-auto px-4 py-6 space-y-4">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <h1 className="text-2xl font-bold">📋 Anmeldung zum Soier Fünfkampf</h1>
            <p className="text-sm text-muted-foreground">Wettkampf oben auswählen; je Wettbewerb gelten dessen Sichtbarkeit und Anmeldefreigabe.</p>
          </div>
