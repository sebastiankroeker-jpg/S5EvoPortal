    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-5xl mx-auto px-4 py-6 space-y-4">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <h1 className="text-2xl font-bold">📋 Anmeldung zum 33. Soier Fünfkampf 2026</h1>
            <p className="text-sm text-muted-foreground">Jetzt Mannschaft ohne Login anmelden und später per Mail-Link im Portal weiterbearbeiten.</p>
          </div>
