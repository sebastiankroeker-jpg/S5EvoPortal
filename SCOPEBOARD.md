...
P09 | IN_PROGRESS | S5Evo | Owner:s5evo | Ergebnis-Engine v1 | DoD: Ranking + Punkte + Tiebreaks + Ergebnis-UI + Regression gegen 2024-Archivdaten — Scoring-Engine + API + Results-UI live, wartet auf Sebastian-Feedback
