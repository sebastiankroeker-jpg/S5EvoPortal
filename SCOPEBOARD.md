...
P51 | BLOCKED | S5Evo | Owner:s5evo | Registration Confirmation Emails | DoD: Resend verdrahtet, Wettkampf-Orga-Mail + Tenant-Fallback konfigurierbar, Vercel ENV komplett gesetzt, echte Testanmeldung verschickt Mails an Anmelder + Orga — blockiert bis `MAIL_FROM` in Vercel gesetzt ist
