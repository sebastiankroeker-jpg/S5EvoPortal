...
P51 | IN_PROGRESS | S5Evo | Owner:s5evo | Registration Confirmation Emails | DoD: Resend verdrahtet, Wettkampf-Orga-Mail + Tenant-Fallback konfigurierbar, Vercel ENV komplett gesetzt, echte Testanmeldung verschickt Mails an Anmelder + Orga — `MAIL_FROM` gesetzt, Redeploy + Live-Mailtest offen
