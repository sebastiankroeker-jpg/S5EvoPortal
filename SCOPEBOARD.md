...
P50 | DONE | S5Evo | Owner:s5evo | Admin Changelog Feedback | DoD: Admin-Formular + DB + Filterliste für Typ/Status/Ersteller/Datum
P51 | DONE | S5Evo | Owner:s5evo | Registration Confirmation Emails | DoD: Resend verdrahtet, Wettkampf-Orga-Mail + Tenant-Fallback konfigurierbar, Vercel ENV komplett gesetzt, echte Testanmeldung verschickt Mails an Anmelder + Orga — fachlich für 2026 live verifiziert
